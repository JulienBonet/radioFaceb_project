...
export default function Presentation() {
  ...
  return (
    <>
      <Seo
        title="Radio Face B | Présentation"
        description="Bienvenue sur Radio Face B, une groove web radio pour vous"
      />
      <main>
        <Stack sx={{ alignItems: 'center', width: '100%' }}>
          ...
          >
            ...
            <Stack spacing={1.5} sx={{ my: 2, alignItems: 'flex-start' }}>
              <Typography component="h2" sx={radioTypoSxH2}>
                UNE WEB RADIO DE OUF
              </Typography>
              <Typography sx={radioTypoSxP}>
                <strong>Radio Face B</strong> est une web-radio{' '}
                <strong>Groove, Chill, Inattendu</strong>
              </Typography>
              <Typography sx={radioTypoSxP}>
                📻 100 % Musicale, 7 jours sur 7, 24 heures sur 24, garantie{' '}
                <strong>sans publicité</strong> 💥 Pour groover où vous voulez ! Quand vous voulez !
                🌴 .
              </Typography>
              <Typography sx={radioTypoSxP}>
            ...
            <Stack spacing={1.5} sx={{ my: 2, alignItems: 'flex-start' }}>
              <Typography component="h2" sx={radioTypoSxH2}>
                👨‍🎤 UNE PROGRAMMATION ÉCLECTIQUE GROOVE
              </Typography>
              <Typography sx={radioTypoSxP}>
                Une programmation <strong>mijotée avec beaucoup d’Amour</strong> qui explore tous
                les territoires du
            ...
            `}
              ...
              <Typography sx={radioTypoSxP}>
                Un programmation humaine qui suit un cycle circadien parfait pour vous accompagner
            ...
            <Stack spacing={1.5} sx={{ my: 2, alignItems: 'flex-start' }}>
              <Typography component="h2" sx={radioTypoSxH2}>
                🖭 DES MIXTAPES IRRÉSISTIBLES
              </Typography>
              <Typography sx={radioTypoSxP}>
                🎧 Radio Face B, c’est également un réservoir de <strong>Mixtapes</strong> toutes
                plus <strong>délicieuses</strong> à écouter les unes que les autres.
              </Typography>
              <Typography sx={radioTypoSxP}>
                Classée par styles, <strong>vous trouverez votre groove</strong> 😎 Ne boudez pas
                votre plaisir ! It’s
            ...
            >
              ...
              >
                Pour <strong>rester informé de nos actualités</strong>, inscrivez vous à notre
                newsletter
              </Typography>
              <Box sx={{ py: 1 }}>
                <Button
