    ...
    <Stack sx={{ alignItems: 'center', width: '100%' }}>
      ...
      >
        ...
        <Stack spacing={1.5} sx={{ my: 2, alignItems: 'flex-start' }}>
          <Typography sx={ecouterTypoSxP}>Il est très simple d’écouter Radio Face B.</Typography>
          <Typography sx={ecouterTypoSxP}>Vous pouvez le faire par différents moyens :</Typography>
          <Box
            component="ul"
            sx={{
              ...ecouterTypoSxP,
        ...
        <Stack id="site-player" spacing={1.5} sx={{ my: 2, alignItems: 'flex-start' }}>
          ...
          <Typography sx={ecouterTypoSxP}>
            &gt; Il vous suffit d’<strong>enclencher le player</strong> à votre disposition sur la
            {'  '}
        ...
        <Stack id="media-player" spacing={1.5} sx={{ my: 2, alignItems: 'flex-start' }}>
          ...
          <Typography sx={ecouterTypoSxP}>
            &gt; Vous pouvez écouter Radio Face B avec n'importe quel <strong>Media Player</strong>{' '}
            (
            <Box
              component="span"
              sx={{
